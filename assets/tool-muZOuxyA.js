...
`+n.message),null}finally{m(!1)}}async function G(){const t=`你是一個遊戲設計師。請針對主題「${l("theme-name")||l("theme-id")}」提供以下 JSON 資訊：
            ...
            請繁體中文輸出。`,a=await A(t);a&&(c("theme-name",a.name),c("theme-desc",a.description),P||c("theme-id",a.id),c("txt-welcome",a.welcome))}async function O(){const t=`針對遊戲主題「${l("theme-name")}」，生成 10 句 NPC 的閒聊對談(每句15字以內)，
            輸出格式如： { "chats": ["第一句", "第二句", ...] } 
